...
const PROGRAMMATI: Contenuto[] = [
  ...
  { id: 'p2', giorno: 'MAR', data: '22 lug', titolo: 'Reel — Piatto della settimana', canale: 'Instagram Reel' },
  { id: 'p3', giorno: 'GIO', data: '24 lug', titolo: 'Carosello — Nuovo menù estivo', canale: 'Facebook + Instagram' },
  { id: 'p4', giorno: 'VEN', data: '25 lug', titolo: 'Storia — Offerta aperitivo', canale: 'Instagram Story' },
